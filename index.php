...
$experience = [
    [ 
      ...
      'startDate' => 'Jan 2015',
      'endDate' => 'Current',
      'jobDescription' => 'Lorem ipsum dolor sit amet. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit
    ...
    [ 
      ...
      'startDate' => 'Mar 2012',
      'endDate' => 'Dec 2014',
      'jobDescription' => 'Consectetur adipisicing elit. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit
       sunt hic. Nulla tempora soluta ea et odio, unde doloremque repellendus iure, iste.'
    ],
    [ 
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
         ...
         <?php for ($i = 0; $i < count($experience); $i++) : ?>
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $experience[$i]["jobTitle"];?></b></h5>
            ...
            <p><?php echo $experience[$i]["jobDescription"];?></p>
              <hr>
          </div>
          <?php endfor; ?>
          </div>
